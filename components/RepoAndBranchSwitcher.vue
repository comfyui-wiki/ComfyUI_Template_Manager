  ...
  <Card>
    ...
    <CardContent class="space-y-4">
      ...
      <div>
        ...
        <!-- Fork outdated warning -->
        <div v-if="hasFork && forkCompareStatus?.isBehind" class="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded text-sm">
        ...
        <!-- Fork up to date notice -->
        <div v-if="hasFork && forkCompareStatus && !forkCompareStatus.isBehind && !forkCompareStatus.isAhead" class="mt-2 p-2 bg-green-50 border border-green-200 rounded text-xs">
